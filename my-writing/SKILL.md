---
name: my-writing
description: "写作引擎: 先立观点，再一层层剖开主题, 用手术刀式的语言写出 1000-1500 字的深度文章. 用于把一个想法写透、写深、写清. 当用户说写作、写文章、剖析观点、深入展开时自动触发。"
user_invocable: true
---
...
5. **连接词检验**：每个连接词都问自己：如果不写连接词，读者能自己看出关系吗？如果不能 → 改写这两部分，让关系更清晰，或删掉连接词让读者自己看出关系
